...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li class="active"><a href="index.php">Grand Poll</a></li>
  ...
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <div class="well">
        ...
        <p><a href="exclusive.php">Is Death Penality Law Will Help To Reduce Rape Case</a></p><br>
...
<form class="form-horizontal" name="form1" action="grand_in.php" onsubmit="return validate()" method="post"> 
