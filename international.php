...
$sql="SELECT SUM(yes) FROM international";
$records=mysql_query($sql);

$sql="SELECT SUM(no) FROM international";
$records1=mysql_query($sql);

$sql="SELECT SUM(may_be) FROM international";
$records2=mysql_query($sql);

$sql="SELECT SUM(not_interested) FROM international";
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li class="active"><a href="international.php">International Poll</a></li>
  ...
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <div class="well">
        ...
        <p><a href="enviromental.php">Melting Glaciers Are Caused By</a></p><br>
...
<div class="navbar" align="center">
  <img src="img/international/international.png" alt="Sat" class="responsive" style="width:70px"></br>
</div> 
<h3>Urbanization Is The Cause For Deforestation ?</h3>
<h3>Poll Ends On 31 December, 2018</h3>
<h3 id="poll"></h3>


<script language="JavaScript" src="js/exer_5.js"></script>

<label class="container">
<form class="form-horizontal" name="form1" action="international_in.php" onsubmit="return validate()" method="post"> 
...
<input type="hidden" name="ip" id="ip" style="border: none; border-color: white; background-color:white; color:white;"  value="<?php echo $_SERVER['REMOTE_ADDR'];   ?>">
		...
		<label class="container">	
		<label class="col-md-3 box"><h4><b>Yes = <?php while($poll=mysql_fetch_assoc($records)){ echo $poll['SUM(yes)']; } ?></b></h4><label class="btn btn-success"><img src="img/international/yes.PNG" alt="..." class="img-thumbnail img-check"><input type="radio" name="yes" id="yes" value="1" class="hidden" autocomplete="off"></label></label>
		<label class="col-md-3 box"><h4><b>No = <?php while($poll=mysql_fetch_assoc($records1)){ echo $poll['SUM(no)']; } ?></b></h4><label class="btn btn-warning"><img src="img/international/no.PNG" alt="..." class="img-thumbnail img-check"><input type="radio" name="no" id="no" value="1" class="hidden" autocomplete="off"></label></label>
		<label class="col-md-3 box"><h4><b>May Be = <?php while($poll=mysql_fetch_assoc($records2)){ echo $poll['SUM(may_be)']; } ?></b></h4><label class="btn btn-info"><img src="img/international/maybe.PNG" alt="..." class="img-thumbnail img-check"><input type="radio" name="may_be" id="may_be" value="1" class="hidden" autocomplete="off"></label></label>
    ...
    <label class="container">
      <label class="control-label col-sm-2" for="state"><b>Select Country:</b></label>
      <label class="col-sm-4">
