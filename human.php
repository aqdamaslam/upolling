...
$sql="SELECT SUM(yes) FROM human";
$records=mysql_query($sql);

$sql="SELECT SUM(no) FROM human";
$records1=mysql_query($sql);

$sql="SELECT SUM(may_be) FROM human";
$records2=mysql_query($sql);

$sql="SELECT SUM(not_interested) FROM human";
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li class="active"><a href="human.php">Human Rights Poll</a></li>
...
<div class="navbar" align="center">
  <img src="img/human/human_rights.png" alt="Sat" class="responsive" style="width:70px"></br>
</div> 
<h3>Is War Is The Solution For Global Peace ?</h3>
...
<form class="form-horizontal" name="form1" action="human_in.php" onsubmit="return validate()" method="post"> 
