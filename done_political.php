...
<p style="color:crimson;"> <b><?php while($poll=mysql_fetch_assoc($records)){ echo $poll['SUM(bjp+congress+ncp+cpim+aitcp+cpi+bsp+others)']; } ?></b></p>

<h2 align="center">Page Will Be Redirect to Home Page itself in 5 Seconds, If It will not Then <a href="index.php">click here</a></h2></br>
  <p>Local Time</p>
<p id="demo1"></p>
