...
$sql="SELECT SUM(yes+no+may_be+not_interested) FROM enviroment";
...
$(document).ready(function () {
    ...
    window.setTimeout(function () {
        location.href = "enviromental.php";
    }, 5000);
});
</script>
...
<h2 align="center">Page Will Be Redirect to Previous Page itself in 5 Seconds, If It will not Then <a href="enviromental.php">click here</a></h2></br>
  <p>Local Time</p>
<p id="demo1"></p>
