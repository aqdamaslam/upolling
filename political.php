...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li class="active"><a href="political.php">Political Poll</a></li>
    </ul>
...
<form class="form-horizontal" name="form1" action="political_in.php" onsubmit="return validate()" method="post"> 
