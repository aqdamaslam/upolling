...
$sql="SELECT SUM(yes+no+may_be+not_interested) FROM exclusive";
...
<h2 align="center">Page Will Be Redirect to Home Page itself in 5 Seconds, If It will not Then <a href="exclusive.php">click here</a></h2></br>
  <p>Local Time</p>
<p id="demo1"></p>
