...
$sql="SELECT SUM(yes) FROM enviroment";
$records=mysql_query($sql);

$sql="SELECT SUM(no) FROM enviroment";
$records1=mysql_query($sql);

$sql="SELECT SUM(may_be) FROM enviroment";
$records2=mysql_query($sql);

$sql="SELECT SUM(not_interested) FROM enviroment";
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li class="active"><a href="enviromental.php">Enviromental Poll</a></li>
...
<div id="nav">	
<!---<img src="img/enviromental/enviroment_banner.PNG" alt="Banner" class="responsive" width="600" height="400">--->
</div></br>
<div class="navbar" align="center">
  <img src="img/enviromental/sat.png" alt="Sat" class="responsive" style="width:70px"></br>
</div> 
<h3>Is Melting Glaciers Causes Sea Level To Rise ?</h3>
...
<form class="form-horizontal" name="form1" action="enviromental_in.php" onsubmit="return validate()" method="post"> 
...
<input type="hidden" name="ip" id="ip" style="border: none; border-color: white; background-color:white; color:white;"  value="<?php echo $_SERVER['REMOTE_ADDR'];   ?>">
		...
		<label class="container">	
		<label class="col-md-3 box"><h4><b>Yes = <?php while($poll=mysql_fetch_assoc($records)){ echo $poll['SUM(yes)']; } ?></b></h4><label class="btn btn-success"><img src="img/yes.PNG" alt="..." class="img-thumbnail img-check"><input type="radio" name="yes" id="yes" value="1" class="hidden" autocomplete="off"></label></label>
		<label class="col-md-3 box"><h4><b>No = <?php while($poll=mysql_fetch_assoc($records1)){ echo $poll['SUM(no)']; } ?></b></h4><label class="btn btn-warning"><img src="img/no.PNG" alt="..." class="img-thumbnail img-check"><input type="radio" name="no" id="no" value="1" class="hidden" autocomplete="off"></label></label>
		<label class="col-md-3 box"><h4><b>May Be = <?php while($poll=mysql_fetch_assoc($records2)){ echo $poll['SUM(may_be)']; } ?></b></h4><label class="btn btn-info"><img src="img/maybe.PNG" alt="..." class="img-thumbnail img-check"><input type="radio" name="may_be" id="may_be" value="1" class="hidden" autocomplete="off"></label></label>
		<label class="col-md-3 box"><h4><b>Not Interested = <?php while($poll=mysql_fetch_assoc($records3)){ echo $poll['SUM(not_interested)']; } ?></b></h4><label class="btn btn-danger"><img src="img/not_interested.PNG" alt="..." class="img-thumbnail img-check"><input type="radio" name="not_interested" id="not_interested" value="1" class="hidden" autocomplete="off"></label></label>
		</label>
